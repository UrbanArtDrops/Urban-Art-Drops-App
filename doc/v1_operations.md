...
- Admin settings persist SMTP host, SMTP port, SMTP user name and SMTP user email together with the existing public app base URL and map settings; SMTP passwords stay transient in the admin UI and are only forwarded to the dedicated connection-test endpoint
